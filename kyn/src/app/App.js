...
import Student from '../user/add_store/Student';
import View from '../user/View_store/view';
import AboutUs from '../user/aboutus/about';
          ...
          <Switch>
            ...
            <PrivateRoute path="/profile" authenticated={this.state.authenticated} currentUser={this.state.currentUser}
              component={Profile}></PrivateRoute>
               <PrivateRoute path="/add" authenticated={this.state.authenticated} currentUser={this.state.currentUser}
              component={Student}></PrivateRoute>
               <PrivateRoute path="/view" authenticated={this.state.authenticated} currentUser={this.state.currentUser}
              component={View}></PrivateRoute>
