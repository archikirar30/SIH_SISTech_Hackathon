        ...
        return (
            <div className="social-signup">
                <a className="btn btn-block social-btn google" href={GOOGLE_AUTH_URL}>
                    <img src={googleLogo} alt="Google" style={{width:'32px', height:'32px', paddingBottom:'06px'}}/> Sign up with Google</a>
                <a className="btn btn-block social-btn facebook" href={FACEBOOK_AUTH_URL} >
                    <img src={fbLogo} alt="Facebook" style={{width:'32px', height:'32px', paddingBottom:'06px'}}/> Sign up with Facebook</a>
            </div>
        );
    }
}
